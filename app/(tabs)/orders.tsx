...
//   string,
//   { bg: string; text: string; label: string; emoji: string; rotate: string }
// > = {
//   pending: {
//     bg: colors.postit,
//     text: colors.pencil,
//     label: "Collect at timeslot!",
//     emoji: "👨‍🍳",
//     rotate: "-1deg",
//   },
//   collected: {
//     bg: colors.muted,
//     text: colors.pencil + "88",
//     label: "Collected",
//     emoji: "✔️",
//     rotate: "0deg",
//   },
    ...
    return (
      <View style={styles.signInContainer}>
        ...
        <Text style={styles.signInSubtitle}>
          sign in to see your order history and get live status updates
        </Text>
                  ...
                  <View style={styles.orderFooter}>
                    <View style={styles.footerLeft}>
                      ...
                      <Text style={styles.footerText}>
                        collect by{" "}
                        {collectionDate.toLocaleString("en-SG", {
